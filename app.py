...
def get_timeline(user_id):
    timeline = current_app.database.execute(text("""
        ...
        FROM tweets t LEFT JOIN users_follow_list ufl ON ufl.user_id = :user_id
        WHERE t.user_id = :user_id OR ufl.follow_user_id = t.user_id
    """), {
        'user_id': user_id
    }).fetchall()
